...
const closeCarousel = (carouselId) => {
  ...
  setIsAnyCarouselOpen(false); // Esto quitará la opacidad del fondo
    ...
    const array8 = [ '/chacras1.jpg','/chacras2.jpg'];
    const array9 = [ '/pd1.png','/pd2.png', '/pd3.png'];
  ...
  <p>Alcance: Ingeniería de detalle.</p>
    ...
    isCarouselOpen6 ? (
      ...
      <div onClick={() => setIsCarouselOpen6(true)} className='grayscale h-[300px] w-full mb-5 relative overflow-hidden cursor-pointer'>
        <img src={array6[0]} alt='Imagen de inicio' style={{ width: '100%', height: '300px'}} />
      </div>
    )
  )}
...
<div class="data-list">
  ...
  <p>Alcance: Ingeniería de detalle</p>
   ...
   <div className='flex justify-center items-start flex-wrap responsive-padding'>
...
<img src={array9[0]} alt='Imagen de inicio' style={{ width: '95%', height: '300px', objectFit: 'cover'}} />
</div>
)
)}
...
<div class="data-list">
<p>Sup.Cubierta: 165m²</p>
<p>Sup.Semicubierta: 231m²</p>
<p>Sup.Total: 396m²</p>
